...
MagisV2 is configured primarily using the MagisV2 Configurator GUI.
...
![MagisV2 Gui](Screenshots/MagisV2-gui.png)
...
[MagisV2 Configurator on Chrome store](https://chrome.google.com/webstore/detail/MagisV2-configurator/enacoimjcgeinfnnnpajinjgmkahmfgb)
...
Old versions of the configurator can be downloaded from the configurator releases page: https://github.com/MagisV2/MagisV2-configurator/releases
See the README file that comes with the configurator for installation instructions.
 

## CLI

MagisV2 can also be configured by a command line interface.
