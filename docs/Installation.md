...
Make sure you have the [MagisV2 Configurator](https://github.com/MagisV2/MagisV2-configurator) installed, then:

* Connect the flight controller to the PC.
* Start the MagisV2 Configurator.
...
* If this is the first time MagisV2 is flashed to the board, tick the "Full Chip Erase" checkbox.
