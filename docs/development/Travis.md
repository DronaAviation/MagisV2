...
MagisV2 provides Travis build and config files in the repository root.
...
Pleas check the ```notifications``` section in the ```.travis.yml``` file and adjust the irc notifications if you plan on using Travis on your MagisV2 fork
