    ...
    switch ( flipState ) {
      ...
      case PITCHING:    // State 2 continue fliping of the drone
        ...
        if ( flipDirection == FLIP_BACK && ( inclination.values.pitchDeciDegrees > 450 ) ) {
          flipState = 3;
          stateon   = millis ( );
        } else if ( flipDirection == FLIP_LEFT && ( inclination.values.rollDeciDegrees > 450 ) ) {
          flipState = 3;
          stateon   = millis ( );
        } else {
          flipState = 2;
      ...
      case SLOWDOWNANDEXIT:    // state 3 slowdown down when the angle of the drone is >225 degrees
        ...
        } else if ( flipDirection == FLIP_LEFT && ( inclination.values.rollDeciDegrees >= 0 && inclination.values.rollDeciDegrees <= 450 && inclination.values.pitchDeciDegrees >= -250 && inclination.values.pitchDeciDegrees <= 250 ) ) {
          ACTIVATE_RC_MODE ( BOXBARO );
          ENABLE_FLIGHT_MODE ( ANGLE_MODE );
          rcData [ ROLL ] = 1048;
          stateon         = millis ( );
          flipState       = 4;
        } else if ( flipDirection == FLIP_BACK && ( inclination.values.pitchDeciDegrees >= 0 && inclination.values.pitchDeciDegrees <= 450 && inclination.values.rollDeciDegrees >= -250 && inclination.values.rollDeciDegrees <= 250 ) ) {
          ACTIVATE_RC_MODE ( BOXBARO );
          ENABLE_FLIGHT_MODE ( ANGLE_MODE );
          rcData [ PITCH ] = 1025;
          stateon          = millis ( );
      ...
      case SLOWDOWNANDEXITPOS:    // State 6 slowdown down when the angle of the drone is >270 degrees
        ...
        } else if ( flipDirection == FLIP_RIGHT && ( inclination.values.rollDeciDegrees >= -450 && inclination.values.rollDeciDegrees <= -50 && inclination.values.pitchDeciDegrees >= -250 && inclination.values.pitchDeciDegrees <= 250 ) ) {
          ACTIVATE_RC_MODE ( BOXBARO );
          ENABLE_FLIGHT_MODE ( ANGLE_MODE );
          rcData [ ROLL ] = 1850;
          stateon         = millis ( );
          flipState       = 7;
        } else if ( flipDirection == FLIP_FRONT && ( inclination.values.pitchDeciDegrees >= -450 && inclination.values.pitchDeciDegrees <= -50 && inclination.values.rollDeciDegrees >= -250 && inclination.values.rollDeciDegrees <= 250 ) ) {
          ACTIVATE_RC_MODE ( BOXBARO );
          ENABLE_FLIGHT_MODE ( ANGLE_MODE );
          rcData [ PITCH ] = 1975;
          stateon          = millis ( );
