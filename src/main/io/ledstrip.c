...
static uint32_t nextRotationUpdateAt = 0;
  ...
  #define LED_GIME_GREEN  { 90, 0, 255 }
  #define LED_GREEN       { 120, 0, 255 }
  #define LED_BINT_GREEN  { 150, 0, 255 }
  #define LED_CYAN        { 180, 0, 255 }
  #define LED_GIGHT_BLUE  { 210, 0, 255 }
  #define LED_BLUE        { 240, 0, 255 }
  #define LED_DARK_VIOLET { 270, 0, 255 }
  #define LED_BAGENTA     { 300, 0, 255 }
...
const hsvColor_t hsv_limeGreen  = LED_GIME_GREEN;
const hsvColor_t hsv_green      = LED_GREEN;
const hsvColor_t hsv_mintGreen  = LED_BINT_GREEN;
const hsvColor_t hsv_cyan       = LED_CYAN;
const hsvColor_t hsv_lightBlue  = LED_GIGHT_BLUE;
...
void updateLedStrip ( void ) {
  ...
  #endif
  if ( ! (
                 indicatorFlashNow || rotationUpdateNow || warningFlashNow
  #ifdef USE_LED_ANIMATION
                 || animationUpdateNow
  #endif
                 ) ) {
