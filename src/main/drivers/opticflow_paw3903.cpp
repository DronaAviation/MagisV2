...
void initOpticFlow ( ) {
...
#endif
  Peripheral_Init ( GPIO_6 , OUTPUT);
  Peripheral_Write ( GPIO_6, STATE_HIGH );
  ...
  // GPIO.write(Pin14, STATE_HIGH);
  delay ( 2 );
  Peripheral_Write ( GPIO_6, STATE_LOW );
  ...
  //   opticFlowAddress = SPI_read(0x00);
  //
